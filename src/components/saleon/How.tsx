  ...
  return (
    <section id="how" className="relative mx-auto max-w-7xl px-5 py-20 sm:px-8">
      ...
      <div className="mt-10 grid gap-6 overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary-soft/60 to-transparent p-8 lg:grid-cols-[1.2fr_auto]">
        <div>
          <h3 className="font-display text-2xl font-extrabold text-ink">{t.noTime}</h3>
          <p className="mt-2 max-w-2xl text-muted-foreground">{t.noTimeDesc}</p>
        </div>
        <a
          href="#contacts"
          className="inline-flex h-12 items-center justify-center self-center gap-2 rounded-full bg-ink px-6 text-sm font-semibold text-background transition hover:bg-primary"
        >
          {t.cta}
        </a>
      </div>
